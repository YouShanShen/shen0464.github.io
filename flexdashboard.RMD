...
DOW_cases_gg <- dow_data %>%
  ...
  ggplot(aes(x = date, y = new_cases_sum, colour = dow, text = text_label)) +
...
ggplotly(DOW_cases_gg, tooltip = "text")  
```
...
```{r, echo = FALSE, fig.width = 4, fig.height = 6}
 ...
 rolling_average %>%
  ...
  plot_ly(
    ...
    type = 'bar',
    colors = 'lightsalmon') %>%
    add_trace(y = ~`7 days new deaths_sum`, type = 'scatter', mode = 'lines', name = "7 Days New Deaths") %>%
layout(title = "New deaths Over Time with 7-day Rolling Average Overlaid",
